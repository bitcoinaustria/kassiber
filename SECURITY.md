...
- **Streaming Stop is best-effort.** Pressing Stop on the assistant hides
  the in-flight reply UI-side; the underlying generation keeps running
  until the model completes. No prompt content is exposed beyond what was
  already sent.
