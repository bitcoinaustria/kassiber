...
- [ ] Settings dialog matches screenshot 5 layout and all MVP buttons work (Backup Data is present only if the backend-storage migration has landed; Install-bundle and Restore remain deferred in MVP — see below)
