...
class ToolCatalogPromptTest(unittest.TestCase):
    ...
    def test_tool_catalog_stability(self):
        expected_tool_names = {
            "ui_chain_analysis_watches_preview", "ui_chain_analysis_watches_list", "ui_chain_analysis_watches_inbox",
            "ui_chain_analysis_watches_create", "ui_chain_analysis_watches_configure", "ui_chain_analysis_watches_delete",
            "ui_chain_analysis_watches_acknowledge", "ui_chain_analysis_watches_evaluate",
            ...
            "ui_chain_analysis_sources_plan", "ui_chain_analysis_sources_list",
            "ui_chain_analysis_sources_authorize", "ui_chain_analysis_sources_revoke",
            "ui_chain_analysis_sources_run",
            "ui_chain_analysis_entropy_start", "ui_chain_analysis_jobs_get", "ui_chain_analysis_jobs_cancel",
            "ui_chain_analysis_psbt_analyze", "ui_chain_analysis_psbt_compare", "ui_chain_analysis_psbt_entropy_start",
            "ui_chain_analysis_datasets_list", "ui_chain_analysis_datasets_get", "ui_chain_analysis_datasets_query",
