...
export const fixtures: Record<string, unknown> = {
  ...
  "ui.reports.lightning_profitability": {
    wallet: "",
    record_count: 72,
    routing_revenue_msat: 132_000,
    routing_revenue_candidate_msat: 139_000,
    invoice_income_msat: 2_100_000,
    bookkeeper_income_net_msat: 1_820_000,
    payment_cost_msat: 41_000,
    rebalance_cost_msat: 66_000,
    onchain_cost_msat: 18_000,
    net_routing_profit_msat: 7_000,
    channels: [
      {
        channel_id: "742x1x0",
        routing_revenue_msat: 92_000,
        cost_msat: 47_000,
        balance_msat: 25_000_000,
        net_msat: 45_000,
        break_even: true,
      },
      {
        channel_id: "742x2x0",
        routing_revenue_msat: 40_000,
        cost_msat: 55_000,
        balance_msat: 18_500_000,
        net_msat: -15_000,
        break_even: false,
      },
    ],
