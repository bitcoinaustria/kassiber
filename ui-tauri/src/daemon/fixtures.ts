...
const MOCK_CUSTODY_COMPONENT = {
  id: "custody:mock-migration",
  lineage_id: "custody:mock-migration",
  revision: 1,
  ...
  allocations: [
    {
      id: "custody-allocation:destination",
      ordinal: 0,
      source_leg_id: "custody-leg:source",
      sink_leg_id: "custody-leg:destination",
      source_amount_msat: 49_998_000_000,
      sink_amount_msat: 49_998_000_000,
    },
    {
      id: "custody-allocation:fee",
      ordinal: 1,
      source_leg_id: "custody-leg:source",
      sink_leg_id: "custody-leg:fee",
      source_amount_msat: 2_000_000,
      sink_amount_msat: 2_000_000,
    },
  ],
  validation: { activatable: true, issues: [] },
};
...
export const fixtures: Record<string, unknown> = {
  ...
  "ui.transactions.dashboard": {
    ...
    history: {
      count: MOCK_TRANSACTIONS.txs.length,
      earliest: null,
      latest: null,
      walletOptions: [],
      paymentMethods: [],
    },
    counts: { all: MOCK_TRANSACTIONS.txs.length, external: MOCK_TRANSACTIONS.txs.length },
    summary: {
      incoming: { count: 0, btc: 0, eur: 0, missingPrice: 0, review: 0, failed: 0 },
      outgoing: { count: 0, btc: 0, eur: 0, missingPrice: 0, review: 0, failed: 0 },
      transfers: { count: 0, btc: 0, eur: 0, missingPrice: 0, review: 0, failed: 0 },
      swaps: { count: 0, btc: 0, eur: 0, missingPrice: 0, review: 0, failed: 0 },
      review: 0,
      pending: 0,
      failed: 0,
    },
    ...
    wallets: [
      {
        ...
        epochs: [
          {
            epoch_id: "mock-retired-policy-epoch",
            status: "retired",
            chain: "bitcoin",
            network: "main",
            created_at: "2021-01-18T16:00:00Z",
            retired_at: "2025-08-01T12:00:00Z",
            sources: [
              {
                ...
                branches: [
                  {
                    branch: "receive",
                    scanned_to_exclusive: 100,
                    highest_used: 37,
                    observed_at: "2025-08-01T12:00:00Z",
                  },
                  {
                    branch: "change",
                    scanned_to_exclusive: 100,
          ...
          {
            epoch_id: "mock-active-policy-epoch",
            status: "active",
            chain: "bitcoin",
            network: "main",
  ...
  "ui.custody.lineage.snapshot": {
    summary: {
      ...
      basis_eligible: 1,
      basis_blocked: 1,
      qualification: "canonical_custody_finality_separate_from_tax_basis",
    },
    items: [
      {
        out_transaction_id: "tx:mock-fanout-out",
        in_transaction_id: "tx:mock-fanout-in",
        occurred_at: "2026-03-12T11:00:00Z",
        asset: "BTC",
        amount_msat: "609000000000",
        from_wallet_id: "wallet:bitcoin-vault",
        from_wallet_label: "Bitcoin Vault",
        to_wallet_id: "wallet:cold-storage",
        to_wallet_label: "Cold Storage",
      ...
      {
        out_transaction_id: "tx:mock-reviewed-out",
        in_transaction_id: "tx:mock-reviewed-in",
        occurred_at: "2021-07-18T16:00:00Z",
        asset: "BTC",
        amount_msat: "990000000000",
        from_wallet_id: "wallet:multisig-b",
        from_wallet_label: "Multisig B",
        to_wallet_id: "wallet:operative-c",
        to_wallet_label: "Operative C",
        custody_state: "internal_reviewed",
        basis_state: "eligible",
        basis_barrier_at: null,
        evidence_reason: "reviewed_gap_bridge",
        network: "main",
        rail: "bitcoin",
      },
    ],
  ...
  "ui.custody.gaps.list": {
    summary: {
      ...
      resolved: 0,
      dismissed: 0,
      unresolved_msat: "10000000000",
      candidate_residual_msat: "10000000000",
      candidate_residual_by_asset: [
        { asset: "BTC", amount_msat: "10000000000" },
      ],
      canonical_unresolved_msat: 0,
      canonical_issue_count: 0,
      canonical_unresolved_by_asset: [],
      canonical_unquantified_issue_count: 0,
      canonical_status: "no_known_custody_gaps",
      canonical_status_text: "No known custody gaps",
      derived_state_current: true,
      qualification:
        "This reports gaps detectable from current imported evidence; it does not assert that every wallet was imported.",
    },
    gaps: [
      {
        gap_id: "custody-gap:og-treasury",
        candidate_fingerprint: "mock-custody-gap-fingerprint",
        status: "needs_review",
        asset: "BTC",
        source_wallet_label: "Multisig B",
        destination_wallet_labels: ["Operative C"],
        source_total_msat: "1000000000000",
        source_fee_msat: "10000000",
        source_debit_msat: "1000010000000",
        return_total_msat: "990000000000",
        residual_msat: "10000000000",
        started_at: "2020-02-10T09:00:00Z",
        ended_at: "2021-01-18T16:00:00Z",
        confidence: "strong",
        ...
        reason_codes: [
          ...
          "promotion_eligible_structured_signal",
          "unresolved_residual",
        ],
        downstream: { affected_disposals: 7, affected_years: [2021, 2022, 2023] },
      },
    ],
    next_cursor: null,
  },
    ...
    history: [
      {
        ...
        authored_source: "user",
        reason: "Reviewed missing Whirlpool interval",
      ...
      },
      {
        ...
        authored_source: "user",
        reason: "Residual was a reviewed external gift",
  ...
  "ui.custody.review.plan": {
    ...
    filed_report_impacts: [
      {
        filed_report_snapshot_id: "filed-report:2021",
        report_kind: "capital_gains",
        report_state: "filed",
        affected_period_start_year: 2021,
        affected_period_end_year: 2021,
        before_classification_summary: {
          disposal: { count: 1, amount_msat: "990000000000" },
        },
        after_classification_summary: {
          internal_retained: { count: 1, amount_msat: "990000000000" },
          custody_suspense: { count: 1, amount_msat: "10000000000" },
        },
        before_gain_summary: { status: "final", fiat_currency: "EUR" },
        after_gain_summary: { status: "pending_journal_rebuild" },
        amendment_warning:
          "Reviewed custody evidence overlaps this saved/filed report period. Rebuild journals and review whether an amended filing is required.",
      },
    ],
  },
  "ui.custody.review.apply": {
    gap_id: "custody-gap:og-treasury",
    status: "resolved",
    component_id: "custody:mock-guided-bridge",
    review_revision: 1,
  },
    ...
    links: [
      {
        ...
        asset: "BTC",
        allocation_amount: 0.15,
        from_allocation_amount: 0.15,
        allocation_policy: "explicit",
        explanation: "Same canonical chain/network/txid/asset transaction.",
        attachments: [],
      },
    ],
    policy:
  ...
  "ui.sync.status": {
    configured: true,
    enabled: true,
    book_id: "mock-sync-book",
    local_member_id: "mock-owner",
    local_device_id: "mock-device",
    local_replica_id: "mock-replica",
    members: 2,
    devices: 2,
    open_conflicts: 0,
    version_vector: { "mock-replica": 18, "mock-peer-replica": 12 },
    transports: [
      {
        id: "mock-mailbox",
        kind: "folder",
        label: "Team mailbox",
        config: { path: "/Users/alice/Shared/Kassiber" },
        credentials_configured: false,
        last_push_at: "2026-07-10T09:30:00Z",
        last_pull_at: "2026-07-10T09:30:00Z",
        last_error_code: null,
        peers: [
          {
            replica_id: "mock-peer-replica",
            member_name: "Accountant",
    ...
    notices: [],
    members_list: [
      { id: "mock-owner", display_name: "Alice", role: "owner", revoked_at: null, active_devices: 1 },
      { id: "mock-accountant", display_name: "Accountant", role: "auditor", revoked_at: null, active_devices: 1 },
    ],
    devices_list: [
      { id: "mock-device", member_id: "mock-owner", member_name: "Alice", label: "Laptop", local_device: 1, revoked_at: null },
      { id: "mock-peer-device", member_id: "mock-accountant", member_name: "Accountant", label: "Office Mac", local_device: 0, revoked_at: null },
    ],
    conflicts: [],
  },
  "ui.sync.enable": { configured: true, enabled: true },
  "ui.sync.disable": { configured: true, enabled: false },
  "ui.sync.transports.list": { transports: [], notices: [] },
  "ui.sync.transports.configure": { id: "mock-mailbox", kind: "folder", label: "Mailbox" },
  "ui.sync.transports.delete": { deleted: true },
  "ui.sync.push": { up_to_date: true, event_count: 0 },
  "ui.sync.pull": { applied_events: 0, conflicts_created: 0 },
  "ui.sync.join_request": { request_id: "mock-request", member_id: "mock-member", device_id: "mock-device" },
  "ui.sync.invite": { invitation: "mock-sealed-invitation", sealed: true },
  "ui.sync.join": { profile_id: "mock-profile", role: "editor" },
  "ui.sync.members.list": { members: [] },
  "ui.sync.members.revoke": { revoked: true },
  "ui.sync.devices.list": { devices: [] },
  "ui.sync.devices.revoke": { revoked: true },
  "ui.sync.conflicts.list": { conflicts: [] },
  "ui.sync.conflicts.resolve": { resolved: true },
