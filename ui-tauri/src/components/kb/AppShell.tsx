...
import { ActiveMaintenanceProgressStrip } from "./ActiveMaintenanceProgress";
...
export function AppShell() {
  ...
  const marketRateRunsInFlight = useIsMutating({
    mutationKey: daemonMutationKey(dataMode, "ui.rates.rebuild"),
  });
    ...
    (id: string) => {
      switch (id) {
        ...
        case "market-rate-refresh":
          return isDaemonKindMutating("ui.rates.rebuild");
        default:
          return true;
      }
    },
                  ...
                  aiFeaturesEnabled ? (
                    <AssistantSessionProvider returnPath={assistantReturnPath}>
                      ...
                      >
                        ...
                        <ActiveMaintenanceProgressStrip />
                        <Outlet />
                      </main>
