...
export function ScreenAssistantMockup({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "pointer-events-auto mx-auto flex w-full flex-col rounded-[28px] border border-zinc-300/90 bg-background/95 p-2 shadow-[0_24px_90px_rgba(15,23,42,0.30),0_3px_18px_rgba(15,23,42,0.14)] ring-1 ring-white/90 backdrop-blur-xl transition-[max-width,transform] duration-200 ease-out dark:border-white/10 dark:bg-zinc-900/80 dark:ring-white/10",
