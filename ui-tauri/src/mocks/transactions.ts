...
const EXTRA_TXS: Tx[] = [
  {
    id: "tx-missing-price",
    externalId: "missing-price-1",
    date: "2026-04-15 08:00",
    occurredAt: "2026-04-15T08:00:00Z",
    type: "Income",
    account: "Cold Storage",
    counter: "Quarantined receipt · missing price",
    amountSat: 410_000,
    eur: null,
    rate: null,
    pricingSourceKind: "missing",
    pricingQuality: "missing",
    reviewStatus: "needs_review",
    quarantineReason: "missing_price",
    tag: "Review",
    tags: ["Review"],
    note: "Needs a fiat price before journal processing can include it.",
    conf: 32,
  },
  {
    id: "tx-missing-basis",
    externalId: "basis-review-1",
    date: "2026-04-12 14:20",
    occurredAt: "2026-04-12T14:20:00Z",
    type: "Expense",
    account: "Multisig Vault",
    counter: "Quarantined spend · missing basis",
    amountSat: -25_000_000,
    feeSat: 1_000,
    eur: -17_855.05,
    rate: 71_420.18,
    pricingSourceKind: "rate_cache",
    pricingQuality: "exact",
    reviewStatus: "blocked",
    quarantineReason: "insufficient_lots",
    tag: "Review",
    tags: ["Review"],
    note: "Needs acquisition history or cost basis before tax export.",
    conf: 84,
  },
  {
    id: "tx13",
