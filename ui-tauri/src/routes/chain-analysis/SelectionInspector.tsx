  ...
  return (
    <aside className="ca-inspector p-4" aria-label={t("inspect")}>
      {node || edge ? (
            ...
            <>
              ...
              <div className="my-4 grid grid-cols-2 gap-2">
                ...
                <Button
                  ...
                  onClick={() => {
                    onTarget(analysisNodeSubject(node));
                  }}
                >
                  {t("setTarget")}
                  ...
                  <div key={key}>
                    ...
                    <dd>
                      <button
                        ...
                        onClick={() =>
                          onSelect({ kind: "node", id: edge[key] })
                        }
                      >
                        {edge[key]}
                      </button>
        ...
        <div className="py-10">
          <GitBranch className="mb-3 size-6 text-muted-foreground/60" />
          <h2 className="text-sm font-medium">{t("select")}</h2>
