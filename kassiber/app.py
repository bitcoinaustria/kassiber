...
def build_parser():
    from .cli.main import build_parser as cli_build_parser

    return cli_build_parser()


def dispatch(conn, args):
    from .cli.main import dispatch as cli_dispatch

    return cli_dispatch(conn, args)


def command_needs_db(args):
    from .cli.main import command_needs_db as cli_command_needs_db

    return cli_command_needs_db(args)
