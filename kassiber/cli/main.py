...
def build_parser() -> argparse.ArgumentParser:
    ...
    wallets_create.add_argument("--source-format", choices=["json", "csv", "btcpay_json", "btcpay_csv", "phoenix_csv", "river_csv", "bullbitcoin_csv", "21bitcoin_csv", "pocketbitcoin_csv", "strike_csv"])
