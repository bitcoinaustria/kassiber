...
_BLOCKPIT_TYPES = {
    ...
    "gift (in)": "Gift received",
    "geschenk (ein)": "Gift received",
    "cashback": "Income",
    "income": "Income",
    "other income": "Income",
    "sonstiger ertrag": "Income",
    "hard fork": "Fork",
    "hardfork": "Fork",
    "mining": "Mining",
    "masternode": "Income",
    "security token income": "Income",
    "security-token-ertrag": "Income",
    "unlabeled withdrawal": "Withdrawal",
    "unlabeled outgoing": "Withdrawal",
    "unlabeled (out)": "Withdrawal",
