...
SYNC_TABLES: tuple[TableSpec, ...] = (
    ...
    TableSpec(
        ...
        (
            ...
            "confidence_at_review", "review_source", "review_notes",
            "payout_asset",
...
NEVER_SYNC_TABLES = PRIVATE_OBSERVER_TABLES | frozenset({"chain_analysis_watches", "chain_analysis_watch_inbox", "filed_report_chain_dependencies", "filed_report_chain_impacts", "filed_report_chain_resolutions"}) | frozenset(
    {
        ...
        "gl_evidence_extractions", "gl_evidence_field_reviews",
        "gl_tax_workpapers", "gl_tax_revisions", "gl_tax_finals",
        "gl_tax_evidence_refs", "gl_tax_line_refs", "gl_tax_prior_refs",
        "gl_source_snapshots", "gl_source_bindings", "gl_source_claims", "gl_source_binding_voids",
        "gl_calculation_artifacts", "gl_projection_policies", "gl_projection_proposals",
        "gl_projection_publications", "gl_projection_voids",
        "gl_ai_proposal_applications",
        "gl_posting_batches",
        "gl_accounting_tasks", "gl_accounting_task_rules", "gl_accounting_task_rule_revocations",
        "gl_accounting_task_cancellations", "gl_accounting_task_claims",
        "gl_accounting_task_evidence_assignments", "gl_accounting_task_receipts",
        "gl_book_valuations", "gl_valuation_publications", "gl_valuation_voids", "gl_valuation_releases",
        "gl_cash_accounts", "gl_cash_counts", "gl_cash_flows",
        "gl_cash_accounts_voids", "gl_cash_counts_voids", "gl_cash_flows_voids",
        "gl_open_item_revisions",
        "gl_bank_allocations", "gl_open_items", "gl_open_item_allocations",
        "gl_schedules", "gl_schedule_revisions",
        "gl_bank_allocation_voids", "gl_bank_statement_voids",
        "gl_open_item_allocation_voids", "gl_open_item_voids",
        "settings",
