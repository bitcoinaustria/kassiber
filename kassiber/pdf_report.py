"""Tiny stdlib-only PDF helpers for text-first reports.

The goal here is not rich layout; it is a reliable, dependency-free PDF
export for Kassiber's local CLI reports. Content is rendered as wrapped
monospace text using the built-in Courier font so the output stays small,
portable, and easy to generate in sandboxed environments.
"""
